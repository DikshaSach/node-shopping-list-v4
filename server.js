...
app.put('/recipes/:id', jsonParser, (req,res)=>{
  ...
  if(req.params.id !== req.body.id){
    const message = `Requested path id ${req.params.id} and requested body id 
    ${req.body.id} are not equivalent.`;
    console.error(message);
    return res.status(400).send(message);
  }
  console.log(`Updating Recipes list for the id:  \`${req.params.id}\``);
  Recipes.update({
    id: req.params.id,
    name: req.body.name,
